...
<div id='header'><a href="{{route('home')}}"><p class='name'>{{ config('app.name') }}</p></a>
...
<button id='postButton' id='postThread'>NEW THREAD</button>
...
<button id='postButton' id='postReply'>NEW REPLY</button>
